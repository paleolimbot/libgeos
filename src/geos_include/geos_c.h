...
typedef GEOSWKTReader_t GEOSWKTReader;
typedef GEOSWKTWriter_t GEOSWKTWriter;
typedef GEOSWKBReader_t GEOSWKBReader;
typedef GEOSWKBWriter_t GEOSWKBWriter;
